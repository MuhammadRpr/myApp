    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.description}>
            Gunakan dokumentasi resmi React dan manfaatkan React Developer Tools
            untuk debugging. Terakhir, bergabunglah dengan komunitas agar
            semangat belajar tetap terjaga.
          </Text>
          <Text style={styles.description}>
            Gunakan dokumentasi resmi React dan manfaatkan React Developer Tools
            untuk debugging. Terakhir, bergabunglah dengan komunitas agar
